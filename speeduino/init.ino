  ...
  switch (boardID)
  {
   ...
   case 31:
    ...
    case 50:
      ...
      pinInjector1 = 9; //Output pin injector 1 is on
      ...
      pinCoil5 = 28; //Pin for coil 1
      pinCoil6 = 14; //Pin for coil 2
      pinCoil7 = 39; //Pin for coil 3
      pinCoil8 = 22; //Pin for coil 4
      //Placeholder only - NOT USED:
      //pinCoil5 = 46; 
      ...
      pinO2_2 = A22; //O2 sensor pin (second sensor)
      pinBat = A1; //Battery reference voltage pin
